...
import com.sandborn.feedback.repository.ApplicationUserRepository;
...
/**
 * REST controller for managing {@link com.sandborn.feedback.domain.ApplicationUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<ApplicationUser> partialUpdateApplicationUser(
        ...
        Optional<ApplicationUser> result = applicationUserRepository
            ...
            .map(existingApplicationUser -> {
                ...
                if (applicationUser.getEmailid() != null) {
                    existingApplicationUser.setEmailid(applicationUser.getEmailid());
                }
                ...
                if (applicationUser.getLocation() != null) {
                    existingApplicationUser.setLocation(applicationUser.getLocation());
                }
                if (applicationUser.getProfilepic() != null) {
                    existingApplicationUser.setProfilepic(applicationUser.getProfilepic());
                }
                if (applicationUser.getProfilepicContentType() != null) {
                    existingApplicationUser.setProfilepicContentType(applicationUser.getProfilepicContentType());
                }
