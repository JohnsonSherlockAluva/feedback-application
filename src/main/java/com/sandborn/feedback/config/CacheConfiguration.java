package com.sandborn.feedback.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.sandborn.feedback.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.sandborn.feedback.repository.UserRepository.USERS_BY_EMAIL_CACHE);
