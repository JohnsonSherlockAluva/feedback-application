...
import { EntityArrayResponseType, GroupsService } from '../service/groups.service';
...
export class GroupsComponent implements OnInit {
  ...
  trackId = (_index: number, item: IGroups): number => this.groupsService.getGroupsIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IGroups[] | null): IGroups[] {
    return data ?? [];
  }
