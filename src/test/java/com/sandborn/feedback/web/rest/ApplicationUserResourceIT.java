...
class ApplicationUserResourceIT {
    ...
    private static final byte[] DEFAULT_PROFILEPIC = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_PROFILEPIC = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_PROFILEPIC_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_PROFILEPIC_CONTENT_TYPE = "image/png";
    ...
    public static ApplicationUser createEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser()
            ...
            .profilepicContentType(DEFAULT_PROFILEPIC_CONTENT_TYPE)
    ...
    public static ApplicationUser createUpdatedEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser()
            ...
            .profilepic(UPDATED_PROFILEPIC)
            .profilepicContentType(UPDATED_PROFILEPIC_CONTENT_TYPE)
    ...
    void createApplicationUser() throws Exception {
        ...
        assertThat(testApplicationUser.getFirstname()).isEqualTo(DEFAULT_FIRSTNAME);
        assertThat(testApplicationUser.getLastname()).isEqualTo(DEFAULT_LASTNAME);
        assertThat(testApplicationUser.getEmailid()).isEqualTo(DEFAULT_EMAILID);
        assertThat(testApplicationUser.getPhonenumber()).isEqualTo(DEFAULT_PHONENUMBER);
        assertThat(testApplicationUser.getLocation()).isEqualTo(DEFAULT_LOCATION);
        assertThat(testApplicationUser.getProfilepic()).isEqualTo(DEFAULT_PROFILEPIC);
        assertThat(testApplicationUser.getProfilepicContentType()).isEqualTo(DEFAULT_PROFILEPIC_CONTENT_TYPE);
    ...
    void getAllApplicationUsers() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.[*].emailid").value(hasItem(DEFAULT_EMAILID)))
            .andExpect(jsonPath("$.[*].phonenumber").value(hasItem(DEFAULT_PHONENUMBER)))
            .andExpect(jsonPath("$.[*].location").value(hasItem(DEFAULT_LOCATION)))
            .andExpect(jsonPath("$.[*].profilepicContentType").value(hasItem(DEFAULT_PROFILEPIC_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].profilepic").value(hasItem(Base64Utils.encodeToString(DEFAULT_PROFILEPIC))))
    ...
    void getApplicationUser() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.emailid").value(DEFAULT_EMAILID))
            .andExpect(jsonPath("$.phonenumber").value(DEFAULT_PHONENUMBER))
            .andExpect(jsonPath("$.location").value(DEFAULT_LOCATION))
            .andExpect(jsonPath("$.profilepicContentType").value(DEFAULT_PROFILEPIC_CONTENT_TYPE))
            .andExpect(jsonPath("$.profilepic").value(Base64Utils.encodeToString(DEFAULT_PROFILEPIC)))
    ...
    void putExistingApplicationUser() throws Exception {
        ...
        ApplicationUser testApplicationUser = applicationUserList.get(applicationUserList.size() - 1);
        assertThat(testApplicationUser.getFirstname()).isEqualTo(UPDATED_FIRSTNAME);
        assertThat(testApplicationUser.getLastname()).isEqualTo(UPDATED_LASTNAME);
        assertThat(testApplicationUser.getEmailid()).isEqualTo(UPDATED_EMAILID);
        assertThat(testApplicationUser.getPhonenumber()).isEqualTo(UPDATED_PHONENUMBER);
        assertThat(testApplicationUser.getLocation()).isEqualTo(UPDATED_LOCATION);
        assertThat(testApplicationUser.getProfilepic()).isEqualTo(UPDATED_PROFILEPIC);
        assertThat(testApplicationUser.getProfilepicContentType()).isEqualTo(UPDATED_PROFILEPIC_CONTENT_TYPE);
    ...
    void partialUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.lastname(UPDATED_LASTNAME).emailid(UPDATED_EMAILID).status(UPDATED_STATUS);
